...
class CheckBox: UIControl {
    ...
    @IBInspectable
    var uncheckedBorderColor: UIColor = CustomColor.Grays.extra
    
    @IBInspectable
    var checkedBorderColor: UIColor = CustomColor.Primary.blue
    
    @IBInspectable
    var checkmarkColor: UIColor = CustomColor.Primary.blue
